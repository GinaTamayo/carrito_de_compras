let mangas = [
    {id: "manga-01", title: "Vinland Saga Vol.01", price: 62.000, category: "historico", image:  "../images/mangas/vinlandSaga01.webp", stock: 12, description: "Thorfinn, un joven vikingo, busca venganza contra el asesino de su padre en la época de los vikingos."},
    {id: "manga-02", title: "Fire Force Vol.26", price: 50.000, category: "accion", image:  "../images/mangas/fireForce26.webp", stock: 16, description: "En un mundo donde las personas se convierten en llamas vivientes, los Fire Force luchan para salvar almas y descubrir la verdad detrás de la combustión humana espontánea."},
    {id: "manga-03", title: "Death Note Vol.05", price: 50.000, category: "drama", image:  "../images/mangas/deathNote.webp", stock: 10, description: "Después de una semana encerrado, Light está listo para renunciar a su Death Note. Liberado de sus acciones pasadas, cree que es inocente. Pero L está decidido a mantenerlo bajo llave, y una nueva ola de crímenes de Kira llega a Japón."},
    {id: "manga-04", title: "Black Butler Vol.12", price: 48.000, category: "fantasia", image:  "../images/mangas/blackButler12.webp", stock: 18, description: "Ciel Phantomhive, junto a su mayordomo demonio Sebastian, resuelve misterios y enfrenta amenazas sobrenaturales."},
    {id: "manga-05", title: "Akame ga Kill Vol.01", price: 55.800, category: "manga", image:  "../images/mangas/akameGaKill01.webp", stock: 10, description: "Tatsumi viaja a la capital en busca de fortuna, pero tras caer en manos de villanos, el Night Raid le rescata. Decide unirse a ellos para luchar contra la injusticia"},
    {id: "manga-06", title: "One Piece Vol.01", price: 50.000, category: "aventura", image:  "../images/mangas/onePiece01.webp", stock: 10, description: 'La historia de Monkey D. Luffy, quien, después de comer la fruta del diablo Gum-Gum, obtiene el poder de estirarse como goma. Jurando ser el rey de los piratas, Luffy busca el legendario "One Piece".'},
    ...
    {id: "manga-08", title: "Demon Slayer Vol.01", price: 70.000, category: "fantasia", image:  "../images/mangas/demon.webp", stock: 10, description: "En la era Taisho, Tanjiro Kamado busca venganza contra un demonio que masacró a su familia y transformó a su hermana en un demonio. Inicia un peligroso viaje para salvarla."},
    {id: "manga-09", title: "Bleach Vol.01", price: 50.000, category: "accion", image: "../images/mangas/bleach01.webp", stock: 10, description: "Descubre un mundo donde Ichigo Kurosaki, con habilidades de un Shinigami, protege a los vivos de los espíritus malignos." },
    {id: "manga-10", title: "Sword Art Online Vol.01", price: 55.000, category: "fantasia", image:  "../images/mangas/swordArtOnline01.webp", stock: 14, description: "Jugadores quedan atrapados en un juego de realidad virtual, Sword Art Online, y deben luchar por su libertad."},
    {id: "manga-11", title: "Bungou Stray Dogs Vol.01", price: 50.000, category: "drama", image: "../images/mangas/bungouStrayDogs.webp", stock: 10, description: "Sumérgete en un drama emocionante con Bungou Stray Dogs, donde los personajes enfrentan desafíos y misterios." },
    {id: "manga-12", title: "Dragon Ball Vol.01", price: 50.000, category: "manga", image: "../images/mangas/dragonBall01.webp", stock: 10, description: "Revive las aventuras épicas de Goku y sus amigos mientras enfrentan desafíos intergalácticos y poderosos enemigos." },
    {id: "manga-13", title: "Haikyuu!! Vol.01", price: 42.000, category: "deportes", image:  "../images/mangas/haikyuu!!01.webp", stock: 15, description: "Hinata Shoyo persigue su sueño de convertirse en el mejor jugador de voleibol a pesar de su baja estatura."},
    {id: "manga-14", title: "The Promised Neverland Vol.02", price: 60.000, category: "suspenso", image:  "../images/mangas/thePromised02.webp", stock: 12, description: "Emma, Norman y Ray descubren oscuros secretos sobre el orfanato en el que crecieron y luchan por sobrevivir."},
    {id: "manga-15", title: "Dragon Ball Z Vol.01", price: 58.000, category: "accion", image:  "../images/mangas/dragonBallZ01.webp", stock: 20, description: "Goku y sus amigos enfrentan desafíos aún mayores, incluyendo poderosos enemigos extraterrestres y amenazas intergalácticas."},
    {id: "manga-16", title: "Yu Yu Hakusho Vol.01", price: 52.000, category: "accion", image:  "../images/mangas/yuYuHakusho01.webp", stock: 16, description: "Yusuke Urameshi, un delincuente juvenil, se convierte en un detective espiritual que protege el mundo de lo paranormal."},
    ...
    {id: "manga-19", title: "Naruto N.01", price: 55.000, category: "aventura", image:  "../images/mangas/naruto01.webp", stock: 15, description: "Naruto Uzumaki, un joven ninja con el sueño de convertirse en el Hokage. Acompaña a Naruto en su viaje lleno de acción y determinación."},
    {id: "manga-20", title: "Fullmetal Alchemist Vol.01", price: 60.000, category: "fantasia", image:  "../images/mangas/fullmetalAlchemist01.webp", stock: 12, description: "Los hermanos Edward y Alphonse Elric buscan la Piedra Filosofal para restaurar sus cuerpos después de un intento fallido de resucitar a su madre."},
    {id: "manga-21", title: "My Hero Academia Vol.01", price: 45.000, category: "accion", image:  "../images/mangas/myHeroAcademia01.webp", stock: 18, description: "En un mundo donde la mayoría tiene superpoderes, Izuku Midoriya sueña con convertirse en un héroe, a pesar de no tener poder."},
    {id: "manga-22", title: "Tokyo Ghoul Vol.01", price: 65.000, category: "suspenso", image:  "../images/mangas/tokyoGhoul01.webp", stock: 10, description: "Kaneki, atacado por un ghoul, se convierte en mitad ghoul y debe aprender a vivir en un mundo donde humanos y ghouls coexisten."},
    {id: "manga-23", title: "Hunter x Hunter Vol.01", price: 58.000, category: "aventura", image:  "../images/mangas/hunterXHunter01.webp", stock: 14, description: "Gon Freecss busca a su padre convirtiéndose en un cazador y enfrentándose a desafíos en un mundo lleno de criaturas y secretos."},
    {id: "manga-24", title: "One Piece Vol.02", price: 50.000, category: "aventura", image:  "../images/mangas/onePiece02.webp", stock: 20, description: "Continúa la aventura de Monkey D. Luffy en busca del tesoro One Piece junto a su tripulación."},
    {id: "manga-25", title: "Demon Slayer Vol.02", price: 72.000, category: "fantasia", image:  "../images/mangas/demonSlayer02.webp", stock: 15, description: "Tanjiro Kamado enfrenta nuevos desafíos mientras busca una cura para su hermana Nezuko y lucha contra demonios."},
    {id: "manga-26", title: "Bleach Vol.02", price: 55.000, category: "accion", image:  "../images/mangas/bleach02.webp", stock: 17, description: "Ichigo Kurosaki, con habilidades de un Shinigami, protege a los vivos de espíritus malignos y los guía al más allá."},
    {id: "manga-27", title: "Attack on Titan Vol.01", price: 68.000, category: "accion", image:  "../images/mangas/attackOnTitan01.webp", stock: 13, description: "La humanidad lucha por sobrevivir contra los titanes devoradores de humanos que amenazan el último refugio de la humanidad."},
    {id: "manga-28", title: "Fairy Tail Vol.01", price: 48.000, category: "aventura", image:  "../images/mangas/fairyTail01.webp", stock: 16, description: "Natsu Dragneel y su gremio de magos, Fairy Tail, enfrentan misiones emocionantes y desafíos mágicos."},
    {id: "manga-29", title: "Noragami Vol.01", price: 50.000, category: "fantasia", image:  "../images/mangas/noragami01.webp", stock: 14, description: "Yato, un dios menor, busca ganar seguidores y convertirse en un dios reconocido mientras enfrenta criaturas espirituales."},
    {id: "manga-30", title: "Black Clover Vol.01", price: 53.000, category: "fantasia", image:  "../images/mangas/blackClover01.webp", stock: 18, description: "Asta, un joven sin poderes mágicos en un mundo lleno de magia, busca convertirse en el Rey Mago."},
