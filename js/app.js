let mangas = [
    ...
    {id: "manga-07", title: "One Punch Man Vol.01", price: 100.000, category: "accion", stock: 10, description: "Aventura llena de acción con un héroe capaz de derrotar a sus enemigos de un solo golpe." },
    {id: "manga-08", title: "Kimetsu no Yaiba Vol.01", price: 70.000, category: "manga", image:  "../images/mangas/demon.jpg", stock: 10, description: "En la era Taisho, Tanjiro Kamado busca venganza contra un demonio que masacró a su familia y transformó a su hermana en un demonio. Inicia un peligroso viaje para salvarla."},
    {id: "manga-09", title: "Bleach N.01", price: 50.000, category: "manga", stock: 10, description: "Descubre un mundo donde Ichigo Kurosaki, con habilidades de un Shinigami, protege a los vivos de los espíritus malignos." },
    {id: "manga-11", title: "Bungou Stray Dogs Vol.01", price: 50.000, category: "drama", stock: 10, description: "Sumérgete en un drama emocionante con Bungou Stray Dogs, donde los personajes enfrentan desafíos y misterios." },
    {id: "manga-12", title: "Dragon Ball Vol.01", price: 50.000, category: "manga", stock: 10, description: "Revive las aventuras épicas de Goku y sus amigos mientras enfrentan desafíos intergalácticos y poderosos enemigos." },
    ...
    {id: "manga-18", title: "Akuma no Riddle Vol.05", price: 30.000, category: "fantasia", stock: 10, description: "Sumérgete en un mundo de fantasía con Akuma no Riddle, donde los personajes se enfrentan a desafíos sobrenaturales." },
    ...
    {id: "manga-25", title: "Demon Slayer Vol.02", price: 72.000, category: "manga", image:  "../images/mangas/demonSlayer02.jpg", stock: 15, description: "Tanjiro Kamado enfrenta nuevos desafíos mientras busca una cura para su hermana Nezuko y lucha contra demonios."},
    {id: "manga-26", title: "Bleach Vol.02", price: 55.000, category: "manga", image:  "../images/mangas/bleach02.jpg", stock: 17, description: "Ichigo Kurosaki, con habilidades de un Shinigami, protege a los vivos de espíritus malignos y los guía al más allá."},
    ...
    {id: "manga-31", title: "Haikyuu!! Vol.01", price: 42.000, category: "deportes", image:  "../images/mangas/haikyuu01.jpg", stock: 15, description: "Hinata Shoyo persigue su sueño de convertirse en el mejor jugador de voleibol a pesar de su baja estatura."},
    {id: "manga-32", title: "The Promised Neverland Vol.01", price: 60.000, category: "suspenso", image:  "../images/mangas/promisedNeverland01.jpg", stock: 12, description: "Emma, Norman y Ray descubren oscuros secretos sobre el orfanato en el que crecieron y luchan por sobrevivir."},
    {id: "manga-33", title: "Dragon Ball Z Vol.01", price: 58.000, category: "accion", image:  "../images/mangas/dragonBallZ01.jpg", stock: 20, description: "Goku y sus amigos enfrentan desafíos aún mayores, incluyendo poderosos enemigos extraterrestres y amenazas intergalácticas."},
    {id: "manga-34", title: "Yu Yu Hakusho Vol.01", price: 52.000, category: "accion", image:  "../images/mangas/yuYuHakusho01.jpg", stock: 16, description: "Yusuke Urameshi, un delincuente juvenil, se convierte en un detective espiritual que protege el mundo de lo paranormal."},
    {id: "manga-35", title: "Sword Art Online Vol.01", price: 55.000, category: "fantasia", image:  "../images/mangas/swordArtOnline01.jpg", stock: 14, description: "Jugadores quedan atrapados en un juego de realidad virtual, Sword Art Online, y deben luchar por su libertad."},
    {id: "manga-36", title: "Black Butler Vol.01", price: 48.000, category: "fantasia", image:  "../images/mangas/blackButler01.jpg", stock: 18, description: "Ciel Phantomhive, junto a su mayordomo demonio Sebastian, resuelve misterios y enfrenta amenazas sobrenaturales."},
    {id: "manga-37", title: "Death Parade Vol.01", price: 40.000, category: "drama", image:  "../images/mangas/deathParade01.jpg", stock: 15, description: "En el bar Quindecim, los muertos juegan juegos para decidir su destino después de la muerte."},
    {id: "manga-38", title: "Vinland Saga Vol.01", price: 62.000, category: "historico", image:  "../images/mangas/vinlandSaga01.jpg", stock: 12, description: "Thorfinn, un joven vikingo, busca venganza contra el asesino de su padre en la época de los vikingos."},
    {id: "manga-39", title: "Fire Force Vol.01", price: 50.000, category: "accion", image:  "../images/mangas/fireForce01.jpg", stock: 16, description: "En un mundo donde las personas se convierten en llamas vivientes, los Fire Force luchan para salvar almas y descubrir la verdad detrás de la combustión humana espontánea."}
];
